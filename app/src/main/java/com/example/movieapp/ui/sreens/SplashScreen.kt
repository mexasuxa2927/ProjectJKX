...
class SplashScreen : Fragment() {
    ...
    val viewModel:MyViewModel by hiltNavGraphViewModels(R.id.mynav_host)
    ...
    private fun loadBackgroundPicture() {
        var a   = (0..9).random()
        viewModel.getFirstPageBackground().observe(viewLifecycleOwner){
            it.onSuccess {

                Glide.with(requireContext()).load(it[a].posterUrl).into(binding.backgroundImage)
            }.onFailure {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            com.example.movieapp.ui.sreens.SplashScreen().apply {
